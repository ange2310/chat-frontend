                    ...
                    <div class="mb-6">
                        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                ...
                                <button onclick="adminClient.refreshGroupRooms()" 
                                        class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 btn-responsive flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div id="activeGroupChat" class="hidden">
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div class="flex items-center justify-between p-4 border-b border-gray-200">
                                <div class="flex items-center gap-3">
                                    <button onclick="adminClient.exitGroupChat()" 
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <button id="toggleSilentModeBtn" onclick="adminClient.toggleGroupSilentMode()" 
                                    ...
                                    <button onclick="adminClient.showGroupParticipants()" 
                                ...
                                <div id="groupChatInputEnabled" class="flex items-end gap-3">
                                    <div class="flex-1">
                                        <textarea id="groupMessageInput" 
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 resize-none"
                                                rows="2"
    ...
    <div id="groupParticipantsModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
            <div class="flex items-center justify-between p-4 border-b border-gray-200">
                ...
                <button onclick="adminClient.closeGroupParticipants()" 
                        class="p-2 text-gray-400 hover:text-gray-600 rounded-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
